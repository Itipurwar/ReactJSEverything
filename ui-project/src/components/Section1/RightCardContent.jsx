...
const RightCardContent = (props) => {
  return (
        <div className='absolute top-0 left-0 h-full w-full p-8 flex flex-col justify-between'>
            ...
            <div>
                <p className='text-shadow-2xs text-lg text-white mb-14 leading-relaxed'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat, voluptatum! assumenda fugit sint vero.</p>
